...
<div class="bg-gray-200 py-32 px-10 min-h-screen ">
  <div class="bg-white p-10 md:w-3/4 lg:w-1/2 mx-auto">
      ...
      <h1 class="text-3xl text-center font-bold text-gray-600 mb-5">Créer une recette</h1>
    ...
    <form action="{{ route('recipes.store') }}" method="post" enctype="multipart/form-data">
      ...
      <div class="flex items-center mb-5">
        ...
        <input placeholder="Titre" type="text" name="titre" id="titre" value="{{ old('titre') }}"
      ...
      <div class="flex items-center mb-5">
          ...
          <input placeholder="Description" type="text" name="description" id="description" value="{{ old('description') }}"
                 class="flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400 
                        text-gray-600 placeholder-gray-400
                        outline-none">
            @error('description')
      ...
      <div class="flex items-center mb-5">
        ...
        <div class="flex items-center mb-5">
          ...
          <input placeholder="Temps de préparation" type="text" name="temps_de_preparation" id="temps_de_preparation" value="{{ old('temps_de_preparation') }}"
                 class="flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400 
                        text-gray-600 placeholder-gray-400
                        outline-none">
        ...
        <div class="flex items-center mb-5">
          ...
          <input placeholder="Temps de cuisson" type="text" name="temps_de_cuisson" id="temps_de_cuisson" value="{{ old('temps_de_cuisson') }}"
                 class="flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400 
                        text-gray-600 placeholder-gray-400
                        outline-none">
        ...
        <div class="flex items-center mb-5">
          ...
          <input placeholder="Niveau de difficulté" type="text" name="niveau_de_difficulte" id="niveau_de_difficulte" value="{{ old('niveau_de_difficulte') }}"
                 class="flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400 
                        text-gray-600 placeholder-gray-400
                        outline-none">
        </div>

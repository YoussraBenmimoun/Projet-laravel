    ...
    >
      <div class="space-y-6 md:space-y-10 mt-10">
        ...
        <div id="profile" class="space-y-3">
          <img
            src="{{asset('storage/images/blogueuse.png')}}"
            alt="Avatar user"
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 text-center">Administratrice</p>
          </div>
        </div>
        <div
        ...
        <div id="menu" class="flex flex-col space-y-2">
          ...
          <a
            href="{{route('recipes.showImportForm')}}"
            class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
          >
            <svg
              class="w-6 h-6 fill-current inline-block"
          ...
          class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
          >
              <svg class="w-6 h-6 fill-current inline-block" 
              fill="currentColor" 
              viewBox="0 0 20 20" 
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" d="M10 12a1 1 0 110-2h9a1 1 0 110 2h-9zM4.293 10.293a1 1 0 011.414-1.414L10 12.586l4.293-4.293a1 1 0 111.414 1.414l-5 5a1 1 0 01-1.414 0l-5-5a1 1 0 01-0.707-0.293z" clip-rule="evenodd" />
              </svg>
